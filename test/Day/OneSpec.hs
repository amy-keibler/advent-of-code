...
spec = do
  ...
  describe "solve opposite captcha" $ do
    it "handles 1212" $
      solveOppositeCaptcha [1,2,1,2] `shouldBe` 6
    it "handles 1221" $
      solveOppositeCaptcha [1,2,2,1] `shouldBe` 0
    it "handles 123425" $
      solveOppositeCaptcha [1,2,3,4,2,5] `shouldBe` 4
    it "handles 123123" $
      solveOppositeCaptcha [1,2,3,1,2,3] `shouldBe` 12
    it "handles 12131415" $
      solveOppositeCaptcha [1,2,1,3,1,4,1,5] `shouldBe` 4
